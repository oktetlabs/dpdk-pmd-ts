...
/** RSS hash protocols */
#define TEST_ETH_RSS_IPV4               (1ULL << TARPC_RTE_ETH_RSS_IPV4)
#define TEST_ETH_RSS_FRAG_IPV4          (1ULL << TARPC_RTE_ETH_RSS_FRAG_IPV4)
#define TEST_ETH_RSS_NONFRAG_IPV4_TCP   (1ULL << TARPC_RTE_ETH_RSS_NONFRAG_IPV4_TCP)
#define TEST_ETH_RSS_NONFRAG_IPV4_UDP   (1ULL << TARPC_RTE_ETH_RSS_NONFRAG_IPV4_UDP)
#define TEST_ETH_RSS_NONFRAG_IPV4_SCTP  (1ULL << TARPC_RTE_ETH_RSS_NONFRAG_IPV4_SCTP)
#define TEST_ETH_RSS_NONFRAG_IPV4_OTHER (1ULL << TARPC_RTE_ETH_RSS_NONFRAG_IPV4_OTHER)
#define TEST_ETH_RSS_IPV6               (1ULL << TARPC_RTE_ETH_RSS_IPV6)
#define TEST_ETH_RSS_FRAG_IPV6          (1ULL << TARPC_RTE_ETH_RSS_FRAG_IPV6)
#define TEST_ETH_RSS_NONFRAG_IPV6_TCP   (1ULL << TARPC_RTE_ETH_RSS_NONFRAG_IPV6_TCP)
#define TEST_ETH_RSS_NONFRAG_IPV6_UDP   (1ULL << TARPC_RTE_ETH_RSS_NONFRAG_IPV6_UDP)
#define TEST_ETH_RSS_NONFRAG_IPV6_SCTP  (1ULL << TARPC_RTE_ETH_RSS_NONFRAG_IPV6_SCTP)
#define TEST_ETH_RSS_NONFRAG_IPV6_OTHER (1ULL << TARPC_RTE_ETH_RSS_NONFRAG_IPV6_OTHER)
#define TEST_ETH_RSS_L2_PAYLOAD         (1ULL << TARPC_RTE_ETH_RSS_L2_PAYLOAD)
#define TEST_ETH_RSS_IPV6_EX            (1ULL << TARPC_RTE_ETH_RSS_IPV6_EX)
#define TEST_ETH_RSS_IPV6_TCP_EX        (1ULL << TARPC_RTE_ETH_RSS_IPV6_TCP_EX)
#define TEST_ETH_RSS_IPV6_UDP_EX        (1ULL << TARPC_RTE_ETH_RSS_IPV6_UDP_EX)
#define TEST_ETH_RSS_PORT               (1ULL << TARPC_RTE_ETH_RSS_PORT)
#define TEST_ETH_RSS_VXLAN              (1ULL << TARPC_RTE_ETH_RSS_VXLAN)
#define TEST_ETH_RSS_GENEVE             (1ULL << TARPC_RTE_ETH_RSS_GENEVE)
#define TEST_ETH_RSS_NVGRE              (1ULL << TARPC_RTE_ETH_RSS_NVGRE)
 ...
 *
 * @return @c TRUE if the VLAN identifier is provided or @c FALSE otherwise.
 */
